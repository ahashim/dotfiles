-- from: https://github.com/lukas-reineke/dotfiles/blob/master/vim/lua/lsp/formatting.lua
local M = {}
...
vim.cmd [[command! FormatDisable lua require'custom.plugins.formatting'.formatToggle(true)]]
vim.cmd [[command! FormatEnable lua require'custom.plugins.formatting'.formatToggle(false)]]
